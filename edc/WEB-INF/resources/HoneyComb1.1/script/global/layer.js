        ...
        v: "3.0.1", ie: function () {
            ...
            if (r.path) {
                ...
                l.rel = "stylesheet", l.href = r.path + t, l.id = f, i("#" + f)[0] || o.appendChild(l), "function" == typeof n && !function d() {
                    return ++c > 80 ? e.console && console.error("../../css/global/layer.css: Invalid") : void(1989 === parseInt(i("#" + f).css("width")) ? n() : setTimeout(d, 100))
                }()
            }
        }, ready: function (e) {
            var t = "skinlayercss", i = "1110";
            return a ? layui.addcss("../../css/global/layer.css?v=" + r.v + i, e, t) : r.link("../../css/global/layer.css?v=" + r.v + i, e, t), this
