...
<script type="text/javascript">
    window.onload=function () {
        ...
        $('#courses_manger_menu').siblings('.subtab').find('a').eq(0).addClass('subtab-list-active');
    }};
</script>
<script type="text/javascript" src="${basePath}/resources/eduapp/js/common.js" charset="UTF-8"></script>
<script type="text/javascript" src="${basePath}/resources/eduapp/js/examination.js" charset="UTF-8"></script>
</body>
</html>
