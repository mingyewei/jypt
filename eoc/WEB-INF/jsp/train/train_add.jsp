    ...
    <div id="iframe-box" class="iframe-box">
        <div class="show_iframe">
                ...
                <div class="managepage_group">
                    <%--<input type="hidden" id="Train_id" value="${trainId}">--%>
                ...
                <div class="managepage_group">
                    <label>考试：</label>
                    <input type="radio" name="hasExam" value="1"/>是
                    <input type="radio" name="hasExam"  checked="true" value="0"/>否<%--composetest_exam--%>
                </div>
                <!-- 考试添加成功后，表格数据会显示 -->
                ...
                <div class="managepage_group "  style="margin-left:70px;">
                    ...
                    <!-- 组内具体信息 -->
                    <div class="infogroup_tab_content" style="display: none;">
                        <!-- 组具体信息的选项卡 -->
                        ...
                        <div class="infogroup_tabs_content" id="infogroup_tabs_content" style="display: none">
                            <div class="infogroup_tabs_detail" style="display:block;margin-bottom: 10px">
                                <!-- 组成员编辑页 -->
                                <div class="learn_object" id="learn_object" style="display:inline-block">
                                    <div class="treeInfoCont dis-none">
                                        <span class="spanBg hover" id="treeEdit">编辑</span>
                                    </div>
                                    <div class="userInfoCont dis-none">
                                        <label style="background-color: #FFFFFF;color:#000000">组成员：</label>
                                    ...
                                    <div class="managepage_tree">
                                        ...
                                        <div class="managepage_group" style="margin-bottom: 10px">
                                            <span class="spanBg hover" id="treeSubmit">保存</span>
                                            <%--<span class="spanBg1 hover" id="treeSubmitreturnback">返回</span>--%>
                                        </div>
                                    </div>
                            ...
                            <div class="infogroup_tabs_detail" style="display:none">
                                ...
                                <div class="examTimeCont">
                                   ...
                                   <%-- <span class="spanBg1 hover" id="">返回</span>--%>
                                </div>
                    ...
                    <div class="managepage_group">
                        <label>发布状态：</label>
                        <input type="radio" name="publishStatus" checked="true" value="1"/>是
                        <input type="radio" name="publishStatus" value="0"/>否<%--composetest_exam--%>
                    </div>
                <div class="managepage_group">
...
<div id="addTrainForm" class="dis-none"></div>
        ...
        <div class="compose_test" id="manualcompose">
            ...
            <div class="test_content">
                <div class="half_content float-lt" id="unselected_test">
                    <p>待选</p>
                    <ul>
                        <%--<li id="1" data-type="1">11</li>--%>
                        <%--<li id="2" data-type="2">22</li>--%>
                        <%--<li id="3" data-type="1">33</li>--%>
                        <%--<li id="4" data-type="2">44</li>--%>
                        <%--<li id="5" data-type="1">55</li>--%>
                        <%--<li id="6" data-type="2">66</li>--%>
                        <%--<li id="7" data-type="1">77</li>--%>
                        <%--<li id="8" data-type="2">88</li>--%>
                        <%--<li id="9" data-type="1">99</li>--%>
                    </ul>
                </div>
...
<script type="text/javascript" src="${basePath}/resources/eduapp/js/peixunguanli_add.js" charset="UTF-8"></script>
</body>
</html>
