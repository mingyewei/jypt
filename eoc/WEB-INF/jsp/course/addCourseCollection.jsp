...
<%@ include file="../common/common_menu.jsp"%>
    <div class="content">
        ...
        <div class="message_cont_modal">
            <form action="" method="post" id="addTrainForm" enctype="multipart/form-data" target="_self">
                <input type="hidden" id="Train_id" name="id" value="">
                ...
                <div class="dis-inline" style="margin-top: 15px">
                    ...
                    <div class=" float-lt">
                        ...
                        <div class="managepage_group" id="table_Train" style="display: none;">
                ...
                <div id="composetest_type" class="dis-none">
                    <div class="managepage_group">
                        <label>及格分数：</label>
                        <input type="text" id="passScore" name="passScore" class="input-focus" placeholder="请输入及格分数" />
                    </div>
                    <div class="managepage_group ">
                        <label>组卷类型：</label>
    ...
    <div class="compose_test" id="manualcompose">
        <div class="addTrain-top">
            ...
            <div id="jopz-infosel" class="patientlist_infosel">
                <p data-value='' style="border: 1px solid #CCCCCC; height: 36px; line-height: 36px">全部<i></i></p>
                <ul style="border: 1px solid #CCCCCC;">
            ...
            <div class="managepage_group">
                ...
                <label>考试说明：</label>
                <textarea id="manual_digest" style="height:35px;vertical-align: bottom;" name="digest"  class="input-focus" placeholder=""></textarea>
            </div>
        </div>
        ...
        <div class="test_result">
            <p>
                ...
                <span style="width: 100px">分值<input type="text" id="singletest" /></span>
                <span>多选题：<b id="multinum"></b> 题</span>
                <span style="width: 100px">分值<input type="text" id="multitest" /></span>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" src="${basePath}/resources/eduapp/js/addCourseCollection.js" charset="UTF-8"></script>
</body>
</html>
