...
<div id="ment_modal" class="dis-none">
    ...
    <div class="rolEdit_cont">
        <div class="managepage_group">
            <label>姓名：</label>
            <input type="text" id="authority_username" class="input-focus modalInputWidth"  value="" placeholder="请输入角色名称"/>
        </div>
        <div class="managepage_group">
            <label>所属机构：</label>
            <input type="text" id="authority_org" class="input-focus modalInputWidth"  value="" placeholder="请输入角色名称"/>
        </div>
        <div class="managepage_group">
            <label>所属角色：</label>
            <input type="text" id="authority_role" class="input-focus modalInputWidth"  value="" placeholder="请输入角色名称"/>
        </div>
        <div class="managepage_group">
            <label>管理人员：</label>
...
<script type="text/javascript">
    $(function () {
        $("#authority").addClass('leftmenu-title-down');
        $(':input').labelauty();
    });
</script>
</html>
